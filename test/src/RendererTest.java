...
public class RendererTest {
	...
	writer.flush();
	writer.close();
	assertEquals( stream.toString().length(), 21012, "Rendered differently" );
    }
	...
	writer.flush();
	writer.close();
	assertEquals( stream.toString().length(), 553, "Rendered differently" );
    }
